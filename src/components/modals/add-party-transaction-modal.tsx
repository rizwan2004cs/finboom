        ...
        <form onSubmit={handleSubmit} className="p-5 pb-8 sm:pb-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 w-full px-4 py-3 rounded-xl bg-white/50 dark:bg-white/[0.06] border border-white/40 dark:border-white/[0.06] text-sm text-[#1d1d1f] dark:text-white focus:outline-none focus:ring-2 focus:ring-[#1d1d1f]/10 dark:focus:ring-white/10"
            />
          </div>
